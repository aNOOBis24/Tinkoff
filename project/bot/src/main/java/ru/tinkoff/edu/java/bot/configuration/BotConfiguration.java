...
public class BotConfiguration {
    ...
    private final TrackStopCommand untrackCommand;

    public BotConfiguration(HelpCommand helpCommand, StartCommand startCommand, ListCommand listCommand, TrackCommand trackCommand, TrackStopCommand trackStopCommand) {
        this.helpCommand = helpCommand;
        this.startCommand = startCommand;
        this.listCommand = listCommand;
        this.trackCommand = trackCommand;
        this.untrackCommand = trackStopCommand;
    }
