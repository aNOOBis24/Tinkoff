...
public class BotConfiguration {
    ...
    public BotConfiguration(HelpCommand helpCommand, StartCommand startCommand, ListCommand listCommand, TrackCommand trackCommand, TrackStopCommand untrackCommand) {
