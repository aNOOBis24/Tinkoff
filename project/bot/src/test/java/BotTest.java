...
import ru.tinkoff.edu.java.bot.telegram.commands.CommandsEnum;
...
import ru.tinkoff.edu.java.bot.telegram.processor.UserState;
...
public class BotTest {
    ...
    public void listCommandTestNotEmpty() {
        ...
        listLink.add(new Link(1L, URI.create("https://github.com/aNOOBis24/NewGame+")));
        ...
        String expectedMessage = """
                ...
                https://github.com/aNOOBis24/NewGame+
