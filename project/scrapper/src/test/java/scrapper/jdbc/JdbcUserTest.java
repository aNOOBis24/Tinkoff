...
public class JdbcUserTest extends IntegrationEnvironment {
    ...
    public void addUserTest() {
        ...
        User user = new User(42L, "robZombee", "Rob","Zombie");
    ...
    public void findAllTest() {
        ...
        for (int i = 0; i < 10; i++) {
            User user = new User(42L + i, "McLovin" + i, "Andrey","SomeSecondName");
    ...
    public void findByChatIdTest(){
        ...
        for (int i = 0; i < 10; i++) {
            User user = new User(42L + i, "aNOOBis24" + i, "Azamat","Salimgareev");
