...
@Repository
@Slf4j
public class LinkTemplateRepository implements LinkRepository {
    ...
    public LinkTemplateRepository(JdbcTemplate jdbcTemplate, LinkRowMapper linkRowMapper) {
    ...
    public List<Link> findAll() {
        log.info("findAll() method invocation in linkRepository");
    ...
    public Link findByUrl(String url) {
        log.info("findByUrl() method invocation in linkRepository");
    ...
    public void add(Link link) {
        log.info("add() method invocation in linkRepository");
    ...
    public void updateDate(Link link) {
        log.info("updateDate() method invocation in linkRepository");
    ...
    public void remove(Long id) {
        log.info("remove() method invocation in linkRepository");
    ...
    public List<Link> findOldLinks(Long timeUpdateDelta) {
        log.info("findOldLinks() method invocation in linkRepository");
